...
of fiber loss and amplifier limitations on specific spectral regions.
  ...
  ------------------------------------------------------------------------
  Band             Channels   Bandwidth      GMI Data-Rate  \% Decrease
                              (THz)          (Tb/s)         (vs 50km)
  ---------------- ---------- -------------- -------------- --------------
  O-Band           275        6.9            42.9           21.9%

  E-Band           310        7.8            76.4           13.4%

  S-Band           296        7.4            74.6           27.5%

  C-Band           195        4.9            53.9           11.7%

  L-Band           245        6.1            67.1           13.1%

  U-Band           119        3.0            24.1           33.2%
  ------------------------------------------------------------------------
...
discrete Raman U-band amplifiers and distributed Raman amplification.
  ...
  -------------------------------------------------------------------------
  Band             Amplifier Type     Noise Figure Performance Notes
                                      (NF)         
  ---------------- ------------------ ------------ ------------------------
  **O-Band**       P-DFA / O-BDFA     4.5 -- 7.0   18 or 23 dBm variants;
                                      dB           strong wavelength
                                                   dependent gain.

  **E-Band**       Bismuth (B-DFA)    5.0 -- 6.0   Higher output power
                                      dB           reaching up to 25 dBm.

  **S-Band**       Thulium (T-DFA)    \< 7.0 dB    Based on thulium-doped
                                                   fluoride fibers.

  **C-Band**       Erbium (EDFA)      \~ 5.0 dB    Typical silica-host
                                                   EDFAs; 13 to 22 dBm
                                                   output.

  **L-Band**       3-Stage EDFA       \~ 6.0 dB    Optimized for extended
                                                   long-wavelength
                                                   performance.

  **U-Band**       Discrete Raman     4.2 -- 13.7  Gain variation of \~8 dB
                                      dB\*         across 25 nm spectrum.
  -------------------------------------------------------------------------

*\*U-band NF depends on Raman gain fiber: 4.2 dB for HNLF vs. 8.1--13.7
dB for HNLDSF.*
...
Signal quality was estimated from GMI and LDPC decoding.
  ...
  -------------------- --------------------------------------------------
  S, C, L-Bands        DP-256QAM (50 km) / DP-64QAM (100 km)

  E, U-Bands           DP-64QAM

  O-Band               DP-16QAM (limited by high modulator loss and bias
                       issues)

  Symbol Rate          24.5 GBaud DP-QAM root-raised cosine shaped
                       signals
  -----------------------------------------------------------------------
